...
<body>
    <div class="container">
        <h2 class="card-title text-center mt-5"><strong>Procesar Carga Nueva Persona</strong></h2>
        <div class="d-flex justify-content-center mt-4">
            <div class="table-container">
                <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nombre']) && isset($_POST['dni']) && isset($_POST['edad']) && isset($_POST['genero'])) {
                    ...
                    $consulta = "INSERT INTO persona (nombre, dni, edad, genero) VALUES ('$formName', '$formDNI', '$formEdad', '$formGenero')";
