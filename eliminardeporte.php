...
<body>
    <div class="container">
        <h2 class="text-center mt-4 mb-4"><strong>Eliminar Deportes</strong></h2>
        <div class="d-flex justify-content-center">
            <div class="table-container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
                    ...
                    $consulta = "DELETE FROM deporte WHERE id_deporte='$formID'";
                    ...
                    echo "El Deporte ha sido eliminada de la base de datos.";
                    echo "</div>";
                    mysqli_close($link);
                } else {
