...
<div class="container table-container">
  <h2 class="text-center">Deporte mas Practicado</h2>
  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      $consulta = "SELECT deporte.nombre AS nombre_deporte, COUNT(*) AS cantidad_personas
        FROM deporte
        INNER JOIN realiza ON deporte.id_deporte = realiza.id_deporte
    ...
    if (mysqli_num_rows($resultado) > 0) {
      ...
      echo '<p class="text-center">No hay deportes registrados.</p>';
    }
