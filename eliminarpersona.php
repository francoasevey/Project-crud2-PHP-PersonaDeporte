...
<body>
    <div class="container">
        <h2 class="text-center mt-4 mb-4"><strong>Eliminar Personas</strong></h2>
        <div class="d-flex justify-content-center">
            <div class="table-container">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
                    ...
                    $consulta = "DELETE FROM persona WHERE id_persona='$formID'";
                    ...
                    echo "La persona ha sido eliminada de la base de datos.";
                    echo "</div>";
                    mysqli_close($link);
                } else {
