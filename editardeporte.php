...
<body>
    <div class="container">
        <h2 class="card-title text-center"><strong>Modificar Deporte</strong></h2>
        <div class="d-flex justify-content-center">
            <div class="table-container">
                ...
                $consulta = "UPDATE deporte SET nombre='$formName', descripcion='$formDescripcion', categoria='$formCategoria' WHERE id_deporte='$formID'";
                ...
                echo "Los siguientes datos de el Deporte han sido editados en la base de datos.";
                echo "</div>";
                mysqli_close($link);
                ?>
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $formDescripcion; ?></td>
                            <td><?php echo $formCategoria; ?></td>
                        </tr>
                    </tbody>
                </table>
                <div class="d-flex justify-content-center">
